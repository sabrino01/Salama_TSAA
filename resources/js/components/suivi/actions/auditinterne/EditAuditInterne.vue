...
onMounted(async () => {
    try {
        ...
        const actionResponse = await axios.get(`/api/suivis/${actionId}`, {
            params,
        });
...
const modifierSuivisAI = async () => {
    try {
        ...
        await axios.put(`/api/suivis/${actionId}`, dataToUpdate, {
            params: params,
        });

        router.push("/suivi/actions/auditinterne");
            ...
            <div class="flex-1 p-5 bg-gray-50 pb-16">
                ...
                <div class="w-full mt-5">
                    ...
                    <div class="flex w-full justify-end mt-6">
                        <router-link to="/suivi/actions/auditinterne"
                            ><button
