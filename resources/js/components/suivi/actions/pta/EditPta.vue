...
onMounted(async () => {
    try {
        ...
        const actionResponse = await axios.get(`/api/suivis/pta/${actionId}`, {
            params,
        });
...
const modifierSuivisPTA = async () => {
    try {
        ...
        await axios.put(`/api/suivis/pta/${actionId}`, dataToUpdate, {
            params: params,
        });

        router.push("/suivi/actions/pta");
        toast.success("Action PTA modifiée avec succès !");
    } catch (error) {
        ...
        if (error.response) {
            ...
            toast.error("Erreur lors de la modification de l'action PTA");
        }
    }
};
</script>
            ...
            <div class="flex-1 p-5 bg-gray-50 pb-16">
                ...
                <div class="w-full text-gray-600 mt-5">
                    <p class="indent-4 font-poppins">
                        Dans cet espace, vous pourriez éditer le PTA pour
                        pouvoir faire des modifications sur le PTA sélectionnée.
                    </p>
                </div>
                ...
                <div class="w-full mt-5">
                    ...
                    <div class="flex w-full justify-end mt-6">
                        <router-link to="/suivi/actions/pta"
                            ><button
