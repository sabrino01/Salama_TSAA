...
onMounted(async () => {
    try {
        ...
        const actionResponse = await axios.get(`/api/suivis/ae/${actionId}`, {
            params,
        });
...
const modifierSuivisAE = async () => {
    try {
        ...
        await axios.put(`/api/suivis/ae/${actionId}`, dataToUpdate, {
            params: params,
        });

        router.push("/suivi/actions/ae");
            ...
            <div class="flex-1 p-5 bg-gray-50 pb-16">
                ...
                <div class="w-full text-gray-600 mt-5">
                    <p class="indent-4 font-poppins">
                        Dans cet espace, vous pourriez éditer l'Audit Externe
                        pour pouvoir faire des modifications sur l'Audit Externe
                        sélectionnée.
                    </p>
                </div>
                ...
                <div class="w-full mt-5">
                    ...
                    <div class="flex w-full justify-end mt-6">
                        <router-link to="/suivi/actions/ae"
                            ><button
