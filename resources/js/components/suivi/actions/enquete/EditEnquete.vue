...
const modifierSuivisEnquete = async () => {
    try {
        // Validation basique
        ...
        await axios.put(`/api/suivis/enquete/${actionId}`, dataToUpdate, {
            params: params,
        });

        router.push("/suivi/actions/enquete");
            ...
            <div class="flex-1 p-5 bg-gray-50 pb-16">
                ...
                <div class="w-full text-gray-600 mt-5">
                    <p class="indent-4 font-poppins">
                        Dans cet espace, vous pourriez éditer l'Enquête de
                        Satisfaction pour pouvoir faire des modifications sur
                        l'Enquête de Satisfaction sélectionnée.
                    </p>
                </div>
                ...
                <div class="w-full mt-5">
                    ...
                    <div class="flex w-full justify-end mt-6">
                        <router-link to="/suivi/actions/enquete"
                            ><button
