...
onMounted(async () => {
    try {
        ...
        const actionResponse = await axios.get(
            `/api/actions-responsables/aii/${actionId}`,
            {
                params,
            }
        );
...
const modifierResponsablesAII = async () => {
    try {
        // Validation basique
        ...
        router.push("/responsable/actions/aii");
            ...
            <div class="flex-1 p-5 bg-gray-50 pb-16">
                ...
                <div class="w-full mt-5">
                    ...
                    <div class="flex w-full justify-end mt-6">
                        <router-link to="/responsable/actions/aii"
                            ><button
