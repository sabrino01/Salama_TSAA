...
onMounted(async () => {
    try {
        ...
        const actionResponse = await axios.get(
            `/api/actions-responsables/enquete/${actionId}`,
            { params }
        );
...
const modifierResponsablesEnquete = async () => {
    try {
        // Validation basique
        if (!action.value.constats_id) {
        ...
        router.push("/responsable/actions/enquete");
        toast.success(
            "Action pour Enquête de Satisfaction modifiée avec succès !"
        );
    } catch (error) {
        ...
        if (error.response) {
            ...
            toast.error(
                "Erreur lors de la modification de l'action pour Enquête de Satisfaction"
            );
        }
    }
};
            ...
            <div class="flex-1 p-5 bg-gray-50 pb-16">
                ...
                <div class="w-full mt-5">
                    ...
                    <div class="flex w-full justify-end mt-6">
                        <router-link to="/responsable/actions/enquete"
                            ><button
                        ...
                        >
                        <button
                            @click="modifierResponsablesEnquete"
