...
onMounted(async () => {
    try {
        ...
        const actionResponse = await axios.get(
            `/api/actions-responsables/pta/${actionId}`,
            { params }
        );
...
const modifierResponsablesPTA = async () => {
    try {
        // Validation basique
        if (!action.value.constats_id) {
        ...
        router.push("/responsable/actions/pta");
            ...
            <div class="flex-1 p-5 bg-gray-50 pb-16">
                ...
                <div class="w-full mt-5">
                    ...
                    <div class="flex w-full justify-end mt-6">
                        <router-link to="/responsable/actions/pta"
                            ><button
