            ...
            <div class="flex-1 p-5 bg-gray-50 pb-16">
                ...
                <div class="w-full text-gray-600 mt-5">
                    <p class="indent-4 font-poppins">
                        ...
                        soit Audit Interne, PTA Audit Externe, Audit Interne
                        Inspection, CAC, SWOT et Enquête de Satisfaction.
                    </p>
                </div>

                <!-- Choix d'action à faire(A.I / PTA / CAC/ A.E / SWOT / ENQUETE / A.I.I) -->
