            ...
            <div class="flex-1 overflow-y-auto bg-gray-50">
                <div class="p-5">
                    ...
                    <div class="flex w-full mt-5 ml-4 justify-center space-x-4">
                        <router-link
                            ...
                            :class="{
                                'border-b-4 border-blue-600':
                                    $route.path ===
                                    '/admin/historiques/auditinterne',
                            }"
                        >
                            Audit Interne
                        </router-link>
                        ...
                        <router-link
                            to="/admin/historiques/pta"
                            class="flex items-center justify-center text-black text-2xl font-bold px-4 py-2 rounded-md w-38"
                            :class="{
                                'border-b-4 border-blue-600':
                                    $route.path === '/admin/historiques/pta',
                            }"
                        >
                            PTA
                        </router-link>
                        ...
                        <router-link
                            to="/admin/historiques/ae"
                            class="flex items-center justify-center text-black text-2xl font-bold px-4 py-2 rounded-md w-38"
                            :class="{
                                'border-b-4 border-blue-600':
                                    $route.path === '/admin/historiques/ae',
                            }"
                        >
                            Audit Externe
                        </router-link>
                        ...
                        <router-link
                            to="/admin/historiques/cac"
                            class="flex items-center justify-center text-black text-2xl font-bold px-4 py-2 rounded-md w-38"
                            :class="{
                                'border-b-4 border-blue-600':
                                    $route.path === '/admin/historiques/cac',
                            }"
                        >
                            CAC
                        </router-link>
                        ...
                        <router-link
                            to="/admin/historiques/enquete"
                            class="flex items-center justify-center text-black text-2xl font-bold px-4 py-2 rounded-md w-38"
                            :class="{
                                'border-b-4 border-blue-600':
                                    $route.path ===
                                    '/admin/historiques/enquete',
                            }"
                        >
                            ENQUETE
                        </router-link>
                        ...
                        <router-link
                            to="/admin/historiques/swot"
                            class="flex items-center justify-center text-black text-2xl font-bold px-4 py-2 rounded-md w-38"
                            :class="{
                                'border-b-4 border-blue-600':
                                    $route.path === '/admin/historiques/swot',
                            }"
                        >
                            SWOT
                        </router-link>
        ...
        const fetchHistorique = async (page = 1) => {
            try {
                ...
                if (paginationEnabled.value) {
                    ...
                    const response = await axios.get("/api/historiques/swot", {
