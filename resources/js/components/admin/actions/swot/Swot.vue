...
const voirSWOT = (id) => {
    router.push(`/admin/actions/swot/voir/${id}`);
};

const voirSWOTOther = (id) => {
    router.push(`/admin/actions/swot/voir/other/${id}`);
};

const editerSWOT = (id) => {
    router.push(`/admin/actions/swot/editer/${id}`);
};
                ...
                <div class="p-5">
                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="flex w-full mt-5 ml-4">
                            <!-- Bouton d'ajout -->
                            <router-link to="/admin/actions/swot/ajouter">
                                <button
