...
const voirCac = (id) => {
    router.push(`/admin/actions/cac/voir/${id}`);
};

const voirCacOther = (id) => {
    router.push(`/admin/actions/cac/voir/other/${id}`);
};

const editerCac = (id) => {
    router.push(`/admin/actions/cac/editer/${id}`);
};
                ...
                <div class="p-5">
                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="flex w-full mt-5 ml-4">
                            <!-- Bouton d'ajout -->
                            <router-link to="/admin/actions/cac/ajouter">
                                <button
