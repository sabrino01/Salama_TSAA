...
const formatDateUpdate = (dateString) => {
    ...
    return moment.utc(dateString).format("DD/MM/YYYY à HH:mm"); // Utiliser moment.js pour formater la date
};
                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="w-full text-gray-600 mt-5">
                            <p class="indent-4 font-poppins">
                                Dans cet espace, vous pourriez éditer PTA pour
                                pouvoir faire des modifications sur le PTA
                                sélectionnée.
                            </p>
                        </div>
                        ...
                        <div class="w-full mt-5">
                            ...
                            <!-- Groupe Indicateurs utilisateurs & partenaire -->
                            <div class="flex flex-wrap gap-x-6 gap-y-6 mt-6">
