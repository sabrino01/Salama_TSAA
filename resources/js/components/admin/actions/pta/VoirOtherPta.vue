                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="w-full text-gray-600 mt-5">
                            <p class="indent-4 font-poppins">
                                Dans cet espace, vous pourriez voir et connaître
                                plus d'informations sur le PTA sélectionnée.
                            </p>
                        </div>
                        ...
                        <div class="w-full mt-5">
                            ...
                            <div v-else-if="action">
                                ...
                                <div
                                    class="flex justify-start text-xl gap-20 mt-6"
                                >
                                    <!-- Fréquence -->
                                ...
                                >
                                    ...
                                    <div class="flex w-[48%] items-start">
                                        <span
                                            class="w-[25%] font-semibold text-gray-800"
                                        >
                                ...
                                >
                                    ...
                                    <div class="flex w-[48%] items-start">
                                        <span
                                            class="w-[10%] font-semibold text-gray-800"
                                        >
                                            Action :
                                        </span>
                                        <div
                                ...
                                >
                                    ...
                                    <div class="flex w-[48%] items-start">
                                        <span
                                            class="w-[20%] font-semibold text-gray-800"
                                        >
                                        ...
                                        >
                                            {{
                                                ...
                                                "Aucun indicateurs Utilisateurs défini"
                                            }}
                                        </div>
                                    </div>
                                ...
                                >
                                    ...
                                    >
                                        <p>
                                            Aucune mise à jour des responsables
                                            pour cette action.
                                        </p>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    >
                                        <p>
                                            Aucune mise à jour des suivis pour
                                            cette action.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div
                                    class="bg-white shadow rounded-lg p-6 mb-6 mt-6"
                                >
                                    <h3 class="text-xl font-bold mb-4">
                                        <i
                                    ...
                                    >
                                        <p class="text-sm text-purple-800">
                                            ...
                                            ></i>
                                            Historique des observations par
                                            suivis
                                        </p>
                                    </div>
                                ...
                                <div class="w-full mt-5">
                                    <div
                                        ...
                                        :class="{
                                            ...
                                            'bg-white text-black':
                                                action.statut === 'Non Réalisé',
                                            'bg-purple-400 text-black':
                                                action.statut === 'A Reporter',
                                        }"
                                    >
                                        {{ action.statut }}
                                    </div>
                                ...
                                <div
                                    class="flex w-full text-lg justify-end mt-8"
                                >
