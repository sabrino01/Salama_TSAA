            ...
            <div class="flex-1 p-5 bg-gray-50 pb-16">
                ...
                <div class="w-full text-gray-600 mt-5">
                    <p class="indent-4 font-poppins">
                        Dans l'espace constat, vous pouvez voir et gérer les
                        informations sur les constats, d'ajouter et de faire
                        plus.
                    </p>
                </div>
                ...
                <div class="flex w-full mt-5 ml-4">
                    <!-- Bouton d'ajout -->
                    <router-link to="/admin/informations/constat/ajouter">
                        <button
                    ...
                    <table class="table-fixed w-full h-[11.5rem]">
                        ...
                        <tbody class="font-poppins text-center">
                            <tr>
                                <td>ENC</td>
                                <td>En cours</td>
                                <td class="text-gray-400">Action en cours</td>
                                <td class="space-x-2 items-center">
                                    <button type="button" class="text-blue-500">
                                        <router-link
                                            to="/admin/informations/constat/voir"
                                            >Voir</router-link
                                        >
                                    </button>
                                    <button
                                    ...
                                    >
                                        <router-link
                                            to="/admin/informations/constat/editer"
                                            >Editer</router-link
                                        >
                                    </button>
                            ...
                            <tr>
                                <td>FIN</td>
                                <td>Réalisé</td>
                                <td class="text-gray-400">Action terminer</td>
                                <td class="space-x-2 items-center">
                                    <button type="button" class="text-blue-500">
                                        <router-link
                                            to="/admin/informations/constat/voir"
