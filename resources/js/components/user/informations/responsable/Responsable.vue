...
const chargerResponsable = async (page = 1, search = "") => {
    try {
        ...
        totalResponsable.value = Number(response.data.total) || 0;
...
const voirResponsable = (id) => {
    router.push(`/user/informations/responsable/voir/${id}`);
};

const editerResponsable = (id) => {
    router.push(`/user/informations/responsable/editer/${id}`);
};
                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="w-full text-gray-600 mt-5">
                            <p class="indent-4 font-poppins">
                                Dans l'espace responsable, vous pouvez voir et
                                gérer les responsables pour les actions, ajouter
                                et de faire plus.
                            </p>
                        </div>
                        ...
                        <div class="flex w-full mt-5 ml-4">
                            <!-- Bouton d'ajout -->
                            <router-link
                                to="/user/informations/responsable/ajouter"
                            >
                                <button
