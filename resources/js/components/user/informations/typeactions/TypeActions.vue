...
const voirTypeAction = (id) => {
    router.push(`/user/informations/typeactions/voir/${id}`);
};

const editerTypeAction = (id) => {
    router.push(`/user/informations/typeactions/editer/${id}`);
};
                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="w-full text-gray-600 mt-5">
                            <p class="indent-4 font-poppins">
                                Dans l'espace type d'actions, vous pouvez voir
                                et gérer les types d'actions, ajouter et de
                                faire plus.
                            </p>
                        </div>
                        ...
                        <div class="flex w-full mt-5 ml-4">
                            <!-- Bouton d'ajout -->
                            <router-link
                                to="/user/informations/typeactions/ajouter"
                            >
                                <button
