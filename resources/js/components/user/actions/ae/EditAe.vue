...
const modifierAE = async () => {
    try {
        ...
        router.push("/user/actions/ae");
        toast.success("Action Audit Externe modifiée avec succès !");
    } catch (error) {
        toast.error(
            "Erreur lors de la modification de l'action Audit Externe",
            error
        );
    }
};
...
onMounted(async () => {
    try {
        ...
        const optionsResponse = await axios.get("/api/actions/createAE");
                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="w-full text-gray-600 mt-5">
                            <p class="indent-4 font-poppins">
                                Dans cet espace, vous pourriez éditer l'Audit
                                Externe pour pouvoir faire des modifications sur
                                l'Audit Externe sélectionnée.
                            </p>
                        </div>

                        <!-- Formulaire de modification d'Audit Externe -->
                        <div class="w-full mt-5">
                            <div class="flex w-[42%] justify-end">
                                <input
                                    type="text"
                                    id="num_actions"
                            ...
                            <div class="flex w-auto justify-end mt-6">
                                <router-link to="/user/actions/ae"
                                    ><button
