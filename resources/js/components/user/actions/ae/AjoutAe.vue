...
onMounted(async () => {
    try {
        const response = await axios.get("/api/actions/createAE");
                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="w-full text-gray-600 mt-5">
                            <p class="indent-4 font-poppins">
                                ...
                                nouvelle Audit Externe avec ses informations et
                                encore plus .
                            </p>
                        </div>

                        <!-- Formulaire d'ajout d'audit externe -->
