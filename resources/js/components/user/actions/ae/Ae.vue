...
const formattedActions = computed(() => {
    return actionsAE.value.map((action) => {
...
const voirAuditExterne = (id) => {
    router.push(`/user/actions/ae/voir/${id}`);
};

const voirAuditExterneOther = (id) => {
    router.push(`/user/actions/ae/voir/other/${id}`);
};

const editerAuditExterne = (id) => {
    router.push(`/user/actions/ae/editer/${id}`);
};
...
const filterActions = (row, actions) => {
    ...
    if (row.nom_utilisateur === utilisateurConnecte) {
        ...
        return actions
            ...
            .map((action) => ({
                ...action,
                handler: () => voirAuditExterneOther(row.id), // Remplacer le handler
            }));
    }
};
                ...
                <div class="p-5">
                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="flex w-full mt-5 ml-4">
                            <!-- Bouton d'ajout -->
                            <router-link to="/user/actions/ae/ajouter">
                                <button
