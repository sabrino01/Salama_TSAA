...
const modifierSWOT = async () => {
    try {
        ...
        router.push("/user/actions/swot");
        toast.success("Action SWOT modifiée avec succès !");
    } catch (error) {
        toast.error("Erreur lors de la modification de l'action SWOT", error);
    }
};
...
onMounted(async () => {
    try {
        ...
        const optionsResponse = await axios.get("/api/actions/createSWOT");
                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="w-full text-gray-600 mt-5">
                            <p class="indent-4 font-poppins">
                                Dans cet espace, vous pourriez éditer le SWOT
                                pour pouvoir faire des modifications sur le SWOT
                                sélectionnée.
                            </p>
                        </div>

                        <!-- Formulaire de modification SWOT -->
                        <div class="w-full mt-5">
                            ...
                            <div class="flex w-auto justify-end mt-6">
                                <router-link to="/user/actions/swot"
                                    ><button
