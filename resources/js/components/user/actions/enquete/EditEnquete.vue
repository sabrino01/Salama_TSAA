...
const modifierEnquete = async () => {
    try {
        ...
        router.push("/user/actions/enquete");
        toast.success("Action Enquête de Satisfaction modifiée avec succès !");
    } catch (error) {
        toast.error(
            "Erreur lors de la modification de l'action Enquête de Satisfaction",
            error
        );
    }
};
...
onMounted(async () => {
    try {
        ...
        const optionsResponse = await axios.get("/api/actions/createEnquete");
            ...
            <div class="flex-1 overflow-y-auto bg-gray-50">
                <div class="p-5">
                    ...
                    <div class="flex w-full">
                        ...
                        >
                            Editer Enquête de Satisfaction
                        </div>
                        <div class="basis-[2%]">
                            <Info />
                        </div>
                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="w-full text-gray-600 mt-5">
                            <p class="indent-4 font-poppins">
                                Dans cet espace, vous pourriez éditer l'Enquête
                                de Satisfaction pour pouvoir faire des
                                modifications sur l'Enquête de Satisfaction
                                sélectionnée.
                            </p>
                        </div>

                        <!-- Formulaire de modification d'Enquête de Satisfaction -->
                        <div class="w-full mt-5">
                            ...
                            >
                                ...
                                <span class="text-red-800 font-medium"
                                    >Cette action est en retard selon sa
                                    fréquence</span
                                >
                            </div>
                            ...
                            >
                                ...
                                >
                                    <p class="text-sm text-yellow-800">
                                        ...
                                        responsables et suivis et ne peuvent pas
                                        être modifiées ici.
                                    </p>
                                </div>
                                ...
                                <div
                                    v-if="action.has_suivis_updates"
                                    class="mb-6"
                                >
                                    <h4
                            ...
                            <div v-else class="bg-white shadow rounded-lg mt-8">
                                <div class="text-center py-8 text-gray-500">
                                    ...
                                    <p>
                                        Aucune mise à jour des responsables ou
                                        suivis pour cette action.
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                >
                                    <p class="text-sm text-purple-800">
                                        <i class="fas fa-info-circle mr-1"></i>
                                        Cette section permet d'ajouter des
                                        observations de suivi puisque des
                                        responsables ont mis à jour cette
                                        action.
                                    </p>
                                </div>
                                ...
                                >
                                    <h4 class="font-semibold mb-3">
                                        <i
                                            class="fas fa-plus mr-2 text-green-600"
                                        ></i>
                                        Ajouter une nouvelle observation par
                                        suivi
                                    </h4>
                                    ...
                                    <div>
                                        <div class="mb-4">
                                            ...
                                            >
                                                Si aucune date n'est
                                                sélectionnée, la date actuelle
                                                sera utilisée.
                                            </p>
                                        </div>
                                ...
                                >
                                    <i
                                        class="fas fa-clipboard text-2xl mb-2"
                                    ></i>
                                    <p>
                                        Aucune observation de suivi pour le
                                        moment.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex w-auto justify-end mt-6">
                                <router-link to="/user/actions/enquete"
                                    ><button
