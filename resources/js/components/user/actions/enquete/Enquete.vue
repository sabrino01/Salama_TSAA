...
const formattedActions = computed(() => {
    return actionsEnquete.value.map((action) => {
...
const voirEnquete = (id) => {
    router.push(`/user/actions/enquete/voir/${id}`);
};

const voirEnqueteOther = (id) => {
    router.push(`/user/actions/enquete/voir/other/${id}`);
};

const editerEnquete = (id) => {
    router.push(`/user/actions/enquete/editer/${id}`);
};
...
const exportToPdf = async () => {
    ...
    try {
        ...
        const fileName = `Enquete_Satisfaction_${
...
const generateExcelFile = async (
    ...
    try {
        ...
        saveAs(new Blob([buffer]), "Enquête de Satisfaction.xlsx");
                ...
                <div class="p-5">
                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="flex w-full mt-5 ml-4">
                            <!-- Bouton d'ajout -->
                            <router-link to="/user/actions/enquete/ajouter">
                                <button
