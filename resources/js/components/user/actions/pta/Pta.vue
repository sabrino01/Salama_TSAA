...
const verifierTousLesStatuts = async () => {
    ...
    actionsPTA.value.statut = result;
...
// const creerTousResponsablesSuivis = async () => {
//     try {
//         console.log(
//             "Appel de la route /api/actions/create-responsables-suivis-missing"
//         );
//         const response = await axios.post(
//             "/api/actions/create-responsables-suivis-missing"
//         );
//         console.log("Réponse backend:", response.data);
//         toast.success(response.data.message || "Création terminée !");
//         await chargerActions(currentPage.value, searchQuery.value);
//     } catch (error) {
//         console.error("Erreur lors de la création globale :", error);
//         toast.error("Erreur lors de la création globale !");
//     }
// };
...
const editerPTA = (id) => {
    router.push(`/user/actions/pta/editer/${id}`);
};
...
const exportToPdf = async () => {
    ...
    try {
        ...
        const fileName = `PTA_${new Date().toISOString().split("T")[0]}.pdf`;
        doc.save(fileName);
                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="w-full text-gray-600 mt-5">
                            <p class="indent-4 font-poppins">
                                ...
                                soit Audit Interne , PTA, Audit Externe, CAC,
                                Enquête de Satisfaction , SWOT et d'y ajouter et
                                encore plus.
                            </p>
                        </div>
                        ...
                        <div class="flex w-full mt-5 ml-4">
                            <!-- Bouton d'ajout -->
                            <router-link to="/user/actions/pta/ajouter">
                                <button
                            ...
                            <!-- <div class="relative ml-4">
                        <button
                            @click="creerTousResponsablesSuivis"
                            class="flex items-center justify-center border border-gray-400 text-black px-4 py-2 rounded-md"
                        >
                            Créer tous les responsables et suivis
                        </button>
                    </div> -->
