...
onMounted(async () => {
    try {
        ...
        const optionsResponse = await axios.get("/api/actions/createAII");
                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="w-full text-gray-600 mt-5">
                            <p class="indent-4 font-poppins">
                                ...
                                Interne et Inspection pour pouvoir faire des
                                modifications sur l'Audit Interne et Inspection
                                sélectionnée.
                            </p>
                        </div>
                        ...
                        <div class="w-full mt-5">
                            ...
                            <div class="flex w-auto justify-end mt-6">
                                <router-link to="/user/actions/aii"
                                    ><button
