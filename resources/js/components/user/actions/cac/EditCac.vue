...
const modifierCac = async () => {
    try {
        ...
        router.push("/user/actions/cac");
        toast.success("Action CAC modifiée avec succès !");
    } catch (error) {
        toast.error("Erreur lors de la modification de l'action CAC", error);
    }
};
...
onMounted(async () => {
    try {
        ...
        const optionsResponse = await axios.get("/api/actions/createCac");
                    ...
                    <div class="min-h-[800px]">
                        ...
                        <div class="w-full text-gray-600 mt-5">
                            <p class="indent-4 font-poppins">
                                Dans cet espace, vous pourriez éditer le CAC
                                pour pouvoir faire des modifications sur le CAC
                                sélectionnée.
                            </p>
                        </div>
                        ...
                        <div class="w-full mt-5">
                            <div class="flex w-[46%] justify-end">
                                <input
                                    type="text"
                                    id="num_actions"
                            ...
                            <div class="flex w-auto justify-end mt-6">
                                <router-link to="/user/actions/cac"
                                    ><button
