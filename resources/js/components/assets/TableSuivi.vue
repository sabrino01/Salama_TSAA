        ...
        >
            ...
            <tbody class="font-poppins text-center">
                ...
                <tr
                    ...
                    :key="rowIndex"
                    :class="{
                        'bg-green-300': row.statut_suivi === 'En cours',
                        'bg-red-300': row.statut_suivi === 'En retard',
                        'bg-gray-300': row.statut_suivi === 'Clôturé',
                        'bg-purple-300': row.statut_suivi === 'Abandonné',
                    }"
