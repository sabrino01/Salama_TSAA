                    ...
                    <th
                        ...
                        :style="
                            column.field === 'description'
                                ...
                                : column.field === 'observation_suivi'
                                ? {
            ...
            <tbody class="font-poppins text-center">
                ...
                >
                    ...
                    <td
                        ...
                        :class="{
                            'border-blue-500': row.statut_suivi === 'En cours',
                            'border-red-500': row.statut_suivi === 'En retard',
                            'border-green-500': row.statut_suivi === 'Clôturé',
                            'border-gray-500': row.statut_suivi === 'Abandonné',
                            'border-white': row.statut_suivi === 'Non Réalisé',
                            'border-purple-600':
                                row.statut_suivi === 'A Reporter',
                            'border-green-600': row.statut_suivi === 'Réglé',
                            'border-gray-600': row.statut_suivi === 'Non Réglé',
                        }"
                    >
                        <input
                            type="checkbox"
