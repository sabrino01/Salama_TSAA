<template>
    ...
    >
        ...
        >
            ...
            >
                <h2 class="text-xl font-bold">CAC - {{ titre }}</h2>
            </div>
            ...
            <div class="p-4 overflow-y-auto flex-grow">
                ...
                >
                    Aucune action trouvée avec le statut "{{ titre }}" pour CAC
                </div>
...
async function loadActions() {
    loading.value = true;
    try {
        const response = await axios.get("/api/api/actions/cac", {
            params: {
                statut: props.titre,
            },
        });
        ...
        console.error("Erreur lors du chargement des actions CAC:", error);
    } finally {
        loading.value = false;
    }
}
