<template>
    ...
    >
        ...
        >
            ...
            >
                <h2 class="text-xl font-bold">SWOT - {{ titre }}</h2>
            </div>
            ...
            <div class="p-4 overflow-y-auto flex-grow">
                ...
                >
                    Aucune action trouvée avec le statut "{{ titre }}" pour SWOT
                </div>
...
async function loadActions() {
    loading.value = true;
    try {
        const response = await axios.get("/api/api/actions/swot", {
            params: {
                statut: props.titre,
            },
        });
        ...
        console.error("Erreur lors du chargement des actions SWOT:", error);
    } finally {
        loading.value = false;
    }
}
